package com.curso.inventarios.controlador;

import com.curso.inventarios.excepcion.RecursoNoEncontradoExcepcion;
import com.curso.inventarios.modelo.Producto;
import com.curso.inventarios.servicio.ProductoServicio;
...
public class ProductoControlador {
    ...
    public ResponseEntity<Producto> obtenerProductoPorId(@PathVariable int id){
        ...
        throw new RecursoNoEncontradoExcepcion("No se encontró el producto: "+id);
    }
